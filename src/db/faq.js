...
const faq = [
    ...
    },
    {
        ...
        categories: ['start', 'safety', 'TON'],
        layout: ['text', 'list']
    },
    {
        question: 'How do I purchase TON (TON)?',
        answer: {
