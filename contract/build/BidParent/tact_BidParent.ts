...
function dictValueParserBidChild$Data(): DictionaryValue<BidChild$Data> {
 ...
 type BidParent_init_args = {
    $$type: 'BidParent_init_args';
}

function initBidParent_init_args(src: BidParent_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}

async function BidParent_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initBidParent_init_args({ $$type: 'BidParent_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const BidParent_errors: { [key: number]: { message: string } } = {
...
const BidParent_getters: ABIGetter[] = [
    {"name":"numBids","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"bidAddress","arguments":[{"name":"seqno","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"owner","arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const BidParent_getterMapping: { [key: string]: string } = {
    'numBids': 'getNumBids',
    'bidAddress': 'getBidAddress',
    'owner': 'getOwner',
}

const BidParent_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewBid"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CompleteBid"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class BidParent implements Contract {
    
    static async init() {
        return await BidParent_init();
    }
    
    static async fromInit() {
        const init = await BidParent_init();
        const address = contractAddress(0, init);
        return new BidParent(address, init);
    }
    
    static fromAddress(address: Address) {
        return new BidParent(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  BidParent_types,
        getters: BidParent_getters,
        receivers: BidParent_receivers,
        errors: BidParent_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: NewBid | CompleteBid | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'NewBid') {
            body = beginCell().store(storeNewBid(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CompleteBid') {
            body = beginCell().store(storeCompleteBid(message)).endCell();
        }
    ...
    async getNumBids(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('numBids', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    
    async getBidAddress(provider: ContractProvider, seqno: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(seqno);
        let source = (await provider.get('bidAddress', builder.build())).stack;
