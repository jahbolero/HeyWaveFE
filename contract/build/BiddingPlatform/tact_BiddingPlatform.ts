...
function dictValueParserServiceChild$Data(): DictionaryValue<ServiceChild$Data> {
 ...
 type BiddingPlatform_init_args = {
    $$type: 'BiddingPlatform_init_args';
}

function initBiddingPlatform_init_args(src: BiddingPlatform_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}

async function BiddingPlatform_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initBiddingPlatform_init_args({ $$type: 'BiddingPlatform_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const BiddingPlatform_errors: { [key: number]: { message: string } } = {
...
const BiddingPlatform_types: ABIType[] = [
...
const BiddingPlatform_getters: ABIGetter[] = [
    {"name":"numServices","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"serviceAddress","arguments":[{"name":"serviceId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"owner","arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const BiddingPlatform_getterMapping: { [key: string]: string } = {
    'numServices': 'getNumServices',
    'serviceAddress': 'getServiceAddress',
    'owner': 'getOwner',
}

const BiddingPlatform_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewService"}},
    {"receiver":"internal","message":{"kind":"typed","type":"FinalizeService"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class BiddingPlatform implements Contract {
    
    static async init() {
        return await BiddingPlatform_init();
    }
    
    static async fromInit() {
        const init = await BiddingPlatform_init();
        const address = contractAddress(0, init);
        return new BiddingPlatform(address, init);
    }
    
    static fromAddress(address: Address) {
        return new BiddingPlatform(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  BiddingPlatform_types,
        getters: BiddingPlatform_getters,
        receivers: BiddingPlatform_receivers,
        errors: BiddingPlatform_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: NewService | FinalizeService | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'NewService') {
            body = beginCell().store(storeNewService(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'FinalizeService') {
            body = beginCell().store(storeFinalizeService(message)).endCell();
        }
    ...
    async getNumServices(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('numServices', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    
    async getServiceAddress(provider: ContractProvider, serviceId: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(serviceId);
        let source = (await provider.get('serviceAddress', builder.build())).stack;
